 ...
 */
package be.atbash.config.mp.converter;

import be.atbash.config.mp.converter.testclass.NotParameterizedInterface;
import be.atbash.config.mp.converter.testclass.DoubleParameterizedTypeClass;
import be.atbash.config.mp.converter.testclass.SomeClassConverter1;
import be.atbash.config.mp.util.testclass.SomeClass;
